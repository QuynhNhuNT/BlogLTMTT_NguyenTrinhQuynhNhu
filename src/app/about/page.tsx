  ...
  return (
    <div className="min-h-screen bg-pink-50">
      <div className="container relative max-w-[1600px] py-8 lg:py-16">
        ...
        <div className="flex flex-col items-center space-y-12 lg:flex-row lg:items-start lg:space-x-12 lg:space-y-0">
          {/* Bên trái: Card thông tin cá nhân và Định hướng */}
          <div className="mx-auto w-full max-w-[500px] space-y-10">
            {/* Card thông tin cá nhân */}
            <div className="relative flex flex-col items-center gap-6 rounded-xl bg-secondary px-8 py-12 shadow-xl">
              <Image
              ...
              <div className="mt-16 text-center">
                <h3 className="mt-4 text-3xl font-bold">Nguyễn Trình Quỳnh Như</h3>
                <p className="mt-3 text-center text-xl font-semibold text-primary">
                  Kỹ sư Mạng Máy tính
                </p>
                <div className="mt-6 space-y-3 text-base text-muted-foreground">
                  <p className="font-semibold text-lg text-foreground">Sinh viên Đại học</p>
                ...
                <div className="mt-6 flex items-center justify-center space-x-4">
                  {SOCIALS.map((social) => (
                    <Link
                      ...
                      rel="noreferrer"
                      target="_blank"
                      className="text-primary hover:bg-primary hover:text-primary-foreground transition-colors rounded-full p-4 size-14 bg-primary/10 flex items-center justify-center"
                    >
            ...
            <div className="space-y-6 rounded-2xl border-2 border-gray-200 bg-white p-8 shadow-[0_4px_12px_rgba(0,0,0,0.08),0_0_0_1px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.12),0_0_0_1px_rgba(0,0,0,0.08)] transition-shadow">
              <h2 className="text-2xl lg:text-3xl font-bold">🌱 Định hướng & Mục tiêu nghề nghiệp</h2>
          ...
          <div className="flex-1 space-y-10">
            ...
            <div className="space-y-6 rounded-2xl border-2 border-gray-200 bg-white p-8 shadow-[0_4px_12px_rgba(0,0,0,0.08),0_0_0_1px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.12),0_0_0_1px_rgba(0,0,0,0.08)] transition-shadow">
              <h2 className="text-2xl lg:text-3xl font-bold">🎯 Giới thiệu bản thân</h2>
              <p className="text-xl lg:text-2xl leading-relaxed text-gray-700">
            ...
            <div className="space-y-6 rounded-2xl border-2 border-gray-200 bg-white p-8 shadow-[0_4px_12px_rgba(0,0,0,0.08),0_0_0_1px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.12),0_0_0_1px_rgba(0,0,0,0.08)] transition-shadow">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div className="flex items-center space-x-4 rounded-xl bg-gray-50 p-6 border-2 border-gray-200">
                  <Server className="size-8 text-primary flex-shrink-0" />
                  <h3 className="text-2xl lg:text-3xl font-semibold">Quản trị Hệ thống</h3>
                </div>
                <div className="flex items-center space-x-4 rounded-xl bg-gray-50 p-6 border-2 border-gray-200">
                  <Database className="size-8 text-primary flex-shrink-0" />
                  <h3 className="text-2xl lg:text-3xl font-semibold">Dịch vụ Mạng cơ bản</h3>
                </div>
                <div className="flex items-center space-x-4 rounded-xl bg-gray-50 p-6 border-2 border-gray-200">
                  <Cloud className="size-8 text-primary flex-shrink-0" />
                  <h3 className="text-2xl lg:text-3xl font-semibold">Ảo hóa & Điện toán đám mây</h3>
                </div>
                <div className="flex items-center space-x-4 rounded-xl bg-gray-50 p-6 border-2 border-gray-200">
                  <Shield className="size-8 text-primary flex-shrink-0" />
                  <h3 className="text-2xl lg:text-3xl font-semibold">Bảo mật Mạng</h3>
                </div>
                <div className="flex items-center space-x-4 rounded-xl bg-gray-50 p-6 border-2 border-gray-200">
                  <Code className="size-8 text-primary flex-shrink-0" />
                  <h3 className="text-2xl lg:text-3xl font-semibold">Kỹ năng mềm</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 w-full">
          <div className="space-y-6 rounded-2xl border-2 border-gray-200 bg-white p-8 shadow-[0_4px_12px_rgba(0,0,0,0.08),0_0_0_1px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.12),0_0_0_1px_rgba(0,0,0,0.08)] transition-shadow">
            <h2 className="text-2xl lg:text-3xl font-bold flex items-center gap-4">
